            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div class="bg-gradient-to-br from-blue-50 to-blue-100 backdrop-blur-sm rounded-xl shadow-lg p-6 border-l-4 border-blue-500 transform hover:-translate-y-1 transition-all duration-300 hover:shadow-xl">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-blue-900">Ordinateurs</p>
                    ...
                    <div class="mt-4">
                        @foreach ($sites as $site)
                            <div class="flex justify-between text-xs text-blue-900 py-1 border-b border-blue-200/50">
                                ...
                                <span class="font-medium">{{ $site['computers_count'] }}</span>
                            </div>
                        @endforeach
                    </div>
                    <a href="{{ url('superadmin/materials/computers') }}" class="mt-3 inline-block w-full text-center py-2 bg-blue-500/10 hover:bg-blue-500/20 text-blue-700 rounded-lg transition-all duration-200 transform hover:scale-[1.02]">
                        <span class="inline-flex items-center">
                            Voir la liste complète <i class="fas fa-chevron-right ml-2"></i>
                        </span>
                    </a>
                </div>
                ...
                <div class="bg-gradient-to-br from-purple-50 to-purple-100 backdrop-blur-sm rounded-xl shadow-lg p-6 border-l-4 border-purple-500 transform hover:-translate-y-1 transition-all duration-300 hover:shadow-xl">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-blue-900">Imprimantes</p>
                    ...
                    <div class="mt-4">
                        @foreach ($sites as $site)
                            <div class="flex justify-between text-xs text-blue-900 py-1 border-b border-purple-200/50">
                                <span>Site {{ $site['name'] }}</span>
                                <span class="font-medium">{{ $site['printers_count'] }}</span>
                            </div>
                        @endforeach
                    </div>
                    <a href="{{ url('superadmin/materials/printers') }}" class="mt-3 inline-block w-full text-center py-2 bg-purple-500/10 hover:bg-purple-500/20 text-purple-700 rounded-lg transition-all duration-200 transform hover:scale-[1.02]">
                        <span class="inline-flex items-center">
                            Voir la liste complète <i class="fas fa-chevron-right ml-2"></i>
                        </span>
                    </a>
                ...
                <div class="bg-gradient-to-br from-green-50 to-green-100 backdrop-blur-sm rounded-xl shadow-lg p-6 border-l-4 border-green-500 transform hover:-translate-y-1 transition-all duration-300 hover:shadow-xl">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-blue-900">Téléphones IP</p>
                    ...
                    <div class="mt-4">
                        @foreach ($sites as $site)
                            <div class="flex justify-between text-xs text-blue-900 py-1 border-b border-green-200/50">
                                <span>Site {{ $site['name'] }}</span>
                                <span class="font-medium">{{ $site['ip_phones_count'] }}</span>
                            </div>
                        @endforeach
                    </div>
                    <a href="{{ url('superadmin/materials/ip-phones') }}" class="mt-3 inline-block w-full text-center py-2 bg-green-500/10 hover:bg-green-500/20 text-green-700 rounded-lg transition-all duration-200 transform hover:scale-[1.02]">
                        <span class="inline-flex items-center">
                            Voir la liste complète <i class="fas fa-chevron-right ml-2"></i>
                        </span>
                    </a>
                ...
                <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 backdrop-blur-sm rounded-xl shadow-lg p-6 border-l-4 border-yellow-500 transform hover:-translate-y-1 transition-all duration-300 hover:shadow-xl">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-blue-900">Hotspots</p>
                    ...
                    <div class="mt-4">
                        @foreach ($sites as $site)
                            <div class="flex justify-between text-xs text-blue-900 py-1 border-b border-yellow-200/50">
                                <span>Site {{ $site['name'] }}</span>
                                <span class="font-medium">{{ $site['hotspots_count'] }}</span>
                            </div>
                        @endforeach
                    </div>
                    <a href="{{ url('superadmin/materials/hotspots') }}" class="mt-3 inline-block w-full text-center py-2 bg-yellow-500/10 hover:bg-yellow-500/20 text-yellow-700 rounded-lg transition-all duration-200 transform hover:scale-[1.02]">
                        <span class="inline-flex items-center">
                            Voir la liste complète <i class="fas fa-chevron-right ml-2"></i>
                        </span>
                    </a>
