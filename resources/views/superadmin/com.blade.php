            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="col-span-1 md:col-span-2 lg:col-span-3">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        @if($commercialBranch && $commercialBranch->children)
                            @foreach($commercialBranch->children as $child)
                                                ...
                                                <div class="flex flex-wrap gap-2">
                                                    @if($child->children)
                                                        @foreach($child->children as $subChild)
                                                            @if($subChild->name !== 'GD')
                                                                <a href="{{ route('sites.branch.detail', ['branch' => $subChild->id]) }}" class="flex-1 min-w-[120px]">
                                        ...
                                        <div x-show="isOpen" x-transition class="p-4 bg-purple-50">
                                            <div class="flex flex-col gap-2">
                                                @foreach($subChild->children as $station)
                                                    <a href="{{ route('sites.branch.detail', ['branch' => $station->id]) }}" class="block">
